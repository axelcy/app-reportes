ALTER DATABASE [reportesort] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [reportesort] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [reportesort] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [reportesort] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [reportesort] SET ARITHABORT OFF 
GO
ALTER DATABASE [reportesort] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [reportesort] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [reportesort] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [reportesort] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [reportesort] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [reportesort] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [reportesort] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [reportesort] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [reportesort] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [reportesort] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [reportesort] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [reportesort] SET QUERY_STORE = OFF
GO
USE [reportesort]
GO
...
USE [master]
GO
ALTER DATABASE [reportesort] SET  READ_WRITE 
GO
